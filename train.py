...
def train(opt, data_loader, model, visualizer):
	...
	total_steps = 0
	for epoch in range(opt.epoch_count, opt.niter + opt.total_epoch + 1):
...
if __name__ == '__main__':
	...
	# opt.dataroot = 'D:\\beloved\pytorch\DeblurGAN-Densenet\path\\to\data'
	#opt.dataroot = '/home/wd/Rosa/DeblurGAN-Densenet/path/to/data'
	opt.dataroot = '/home/wd/Rosa/DeblurGAN-Densenet/path/to/data'                                       #'D:\Deeplearning\Rosa\DeblurGAN-Densenet\path\\to\data'
	#opt.dataroot = '/path/to/data'
	opt.learn_residual = True
	opt.resize_or_crop = "crop"
	opt.fineSize = 256
	opt.model = "content_gan"
	opt.gan_type = "gan"
